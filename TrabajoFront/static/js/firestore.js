...
export async function mostrarDatosPresidentes () {
...
export async function mostrarDatosSenadores () {
    const collection = db.collection('candidatos').get();
...
export async function mostrarDatosDiputados () {
    const collection = db.collection('candidatos').get();
...
mostrarDatosPresidentes()
mostrarDatosSenadores()
mostrarDatosDiputados()